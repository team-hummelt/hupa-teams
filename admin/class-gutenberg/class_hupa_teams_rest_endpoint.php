 ...
 * @Since 1.0.0
 */
class Hupa_Teams_Rest_Endpoint
{
    ...
    {
        $version = '1';
        $namespace = 'wp-team-members/v' . $version;
        $base = '/';
        ...
        @register_rest_route(
            ...
            array(
                ...
                'callback' => array($this, 'hupa_team_members_endpoint_get_response'),
     ...
     */
    public function hupa_team_members_endpoint_get_response(WP_REST_Request $request)
    {
    ...
    public function get_method_item($method)
    {
        ...
        switch ($method) {
            case 'get-team-members-block':
                ...
                $terms = apply_filters($this->basename.'/get_custom_terms','team_members_category');
                $catArr = [];
     ...
     * @return object
     */
    public function team_members_get_custom_terms(string $taxonomy): object
    {
        $return = new  stdClass();
        $return->status = false;
