...
class Register_Exec_License {
     ...
     * @return static
     */
    public static function instance( string $basename, string $version, object $config, Hupa_Teams $main, string $plugin_dir ): self {
     ...
     */
    public function __construct( string $basename, string $version, object $config, Hupa_Teams $main, string $plugin_dir ) {
